...
import styles from './galleryDialogBox.module.scss';
        ...
        <div className={styles.dialogbox_wrap}>
          <div className={styles.modal_content}>
            <div className={styles.modal_header}>
              <h5 className={styles.dailog_title}>Select videos or Image</h5>
            </div>
                  ...
                  <>
                    <div className={inputStyles.input_wrap}>
                      ...
                      >
                        ...
                        <input
                          ...
                          onChange={uploadGalleryAttachment}
                          accept="video/*"
                        />
                      </div>
                    </div>
                    ...
                    <div className={styles.input_wrap}>
                      <TextInput
                        ...
                        handleValue={galleryAttachmentURL}
                        handleOnChange={(e) =>
                          setGalleryAttachmentURL(e.target.value)
                        }
                      />
                    </div>
                  </>
